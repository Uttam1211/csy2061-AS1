package com.example.thechristmatic.calculator;
...
public class CalculatorActivity extends AppCompatActivity {
    ...
    private static final char MULTIPILICATION = '*';
    ...
    private MaterialButton button0,button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonDot, buttonAdd, buttonMultiply,
            buttonDivide, buttonPercent,buttonSubtract, buttonClear, buttonEqual, buttonOff;
    ...
    public void allCalculations(){
        if(!Double.isNaN(firstValue)) {
            ...
            if(currentSymbol == ADDITION)
                ...
                firstValue = this.firstValue - secondValue;
            else if (currentSymbol == MULTIPILICATION)
                firstValue = this.firstValue * secondValue;
